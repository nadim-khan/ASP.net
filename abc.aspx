...
<!--									<button class="btn active" id="flat">Flat</button>
        ...
        <script>
            ...
            $(function () {
                ...
                (function () {
                    ...
                    var m2 = '<%= v2 %>';
            alert(m);
            xhr.open('GET', 'demoassets/' + m, true);
            ...
            xhr2.open('GET', 'demoassets/'+m2, true);
            ...
            $('#example-images').click(function () {
                ...
                var m2 = '<%= v2 %>';
               // alert(m);
                $('#dropzone1').html('<img src="demoassets/' + m + '"/>');
                
                $('#dropzone2').html('<img src="demoassets/'+m2+'"/>');
    ...
    function xyz() {
        ...
        document.write("b" + m);
        if (mis <= 30)
            window.location.replace("print.aspx");
        else
